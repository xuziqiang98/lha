...
impl SkillInstructions {
    ...
    pub fn into_backfilled_response_item(self) -> ResponseItem {
        self.into_response_item_with_source(SkillInstructionSource::CompactBackfill)
    }

    fn into_response_item_with_source(self, source: SkillInstructionSource) -> ResponseItem {
...
mod tests {
    ...
    fn test_skill_instructions_round_trip() {
        ...
        let response_item: ResponseItem = expected.clone().into();
