...
use crate::product::app_server_protocol::export::GeneratedSchema;
use crate::product::app_server_protocol::export::write_json_schema;
...
client_request_definitions! {
    ...
    /// List recorded LHA conversations (rollouts) with optional pagination and search.
    ListConversations {
        params: v1::ListConversationsParams,
        response: v1::ListConversationsResponse,
    },
    /// Resume a recorded LHA conversation from a rollout file.
    ResumeConversation {
        params: v1::ResumeConversationParams,
        response: v1::ResumeConversationResponse,
    },
    /// Fork a recorded LHA conversation into a new session.
    ForkConversation {
...
macro_rules! server_request_definitions {
    (
        ...
        pub fn export_server_response_schemas(
            ...
            let mut schemas = Vec::new();
            $(
                schemas.push(crate::product::app_server_protocol::export::write_json_schema::<$response>(
                    out_dir,
        ...
        pub fn export_server_param_schemas(
            ...
            let mut schemas = Vec::new();
            $(
                schemas.push(crate::product::app_server_protocol::export::write_json_schema::<$params>(
                    out_dir,
...
macro_rules! server_notification_definitions {
    (
        ...
        pub fn export_server_notification_schemas(
            ...
            let mut schemas = Vec::new();
            $(schemas.push(crate::product::app_server_protocol::export::write_json_schema::<$payload>(out_dir, stringify!($payload))?);)*
            Ok(schemas)
        }
    };
}
...
macro_rules! client_notification_definitions {
    (
        ...
        pub fn export_client_notification_schemas(
            ...
            let schemas = Vec::new();
            $( $(schemas.push(crate::product::app_server_protocol::export::write_json_schema::<$payload>(_out_dir, stringify!($payload))?);)? )*
            Ok(schemas)
        }
    };
}
...
/// Superset of [`crate::product::file_search::FileMatch`]
#[derive(Serialize, Deserialize, Debug, Clone, PartialEq, JsonSchema, TS)]
...
server_notification_definitions! {
    ...
    /// This event is internal-only. Used by LHA Cloud.
