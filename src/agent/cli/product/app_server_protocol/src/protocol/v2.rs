...
use crate::product::protocol::approvals::ExecPolicyAmendment as CoreExecPolicyAmendment;
...
use crate::product::protocol::config_types::SandboxMode as CoreSandboxMode;
use crate::product::protocol::config_types::Verbosity;
use crate::product::protocol::config_types::WebSearchMode;
use crate::product::protocol::items::AgentMessageContent as CoreAgentMessageContent;
use crate::product::protocol::items::TurnItem as CoreTurnItem;
...
use crate::product::protocol::parse_command::ParsedCommand as CoreParsedCommand;
use crate::product::protocol::plan_tool::PlanItemArg as CorePlanItemArg;
...
use crate::product::protocol::protocol::SkillErrorInfo as CoreSkillErrorInfo;
use crate::product::protocol::protocol::SkillInterface as CoreSkillInterface;
use crate::product::protocol::protocol::SkillMetadata as CoreSkillMetadata;
use crate::product::protocol::protocol::SkillScope as CoreSkillScope;
use crate::product::protocol::protocol::SkillToolDependency as CoreSkillToolDependency;
use crate::product::protocol::protocol::TokenUsage as CoreTokenUsage;
use crate::product::protocol::protocol::TokenUsageInfo as CoreTokenUsageInfo;
use crate::product::protocol::user_input::ByteRange as CoreByteRange;
use crate::product::protocol::user_input::TextElement as CoreTextElement;
use crate::product::protocol::user_input::UserInput as CoreUserInput;
...
v2_enum_from_core!(
    pub enum ReviewDelivery from crate::product::protocol::protocol::ReviewDelivery {
        Inline
    }
);

v2_enum_from_core!(
    pub enum McpAuthStatus from crate::product::protocol::protocol::McpAuthStatus {
        Unsupported,
        NotLoggedIn,
        BearerToken,
        OAuth
...
impl SandboxPolicy {
    pub fn to_core(&self) -> crate::product::protocol::protocol::SandboxPolicy {
        match self {
            SandboxPolicy::DangerFullAccess => {
                crate::product::protocol::protocol::SandboxPolicy::DangerFullAccess
            }
            SandboxPolicy::ReadOnly => crate::product::protocol::protocol::SandboxPolicy::ReadOnly,
            SandboxPolicy::ExternalSandbox { network_access } => {
                crate::product::protocol::protocol::SandboxPolicy::ExternalSandbox {
            ...
            SandboxPolicy::WorkspaceWrite {
                ...
                exclude_slash_tmp,
            } => crate::product::protocol::protocol::SandboxPolicy::WorkspaceWrite {
...
impl From<crate::product::protocol::protocol::SandboxPolicy> for SandboxPolicy {
    fn from(value: crate::product::protocol::protocol::SandboxPolicy) -> Self {
        match value {
            crate::product::protocol::protocol::SandboxPolicy::DangerFullAccess => {
                SandboxPolicy::DangerFullAccess
            }
            crate::product::protocol::protocol::SandboxPolicy::ReadOnly => SandboxPolicy::ReadOnly,
            crate::product::protocol::protocol::SandboxPolicy::ExternalSandbox {
                network_access,
...
impl From<crate::product::protocol::models::WebSearchAction> for WebSearchAction {
    fn from(value: crate::product::protocol::models::WebSearchAction) -> Self {
        match value {
            crate::product::protocol::models::WebSearchAction::Search { query, queries } => {
                WebSearchAction::Search { query, queries }
            }
            crate::product::protocol::models::WebSearchAction::OpenPage { url } => {
                WebSearchAction::OpenPage { url }
            }
            crate::product::protocol::models::WebSearchAction::FindInPage { url, pattern } => {
                WebSearchAction::FindInPage { url, pattern }
            }
            crate::product::protocol::models::WebSearchAction::Other => WebSearchAction::Other,
        }
    }
}
...
#[serde(rename_all = "camelCase")]
#[ts(export_to = "v2/")]
pub struct RawTranscriptItemCompletedNotification {
    pub thread_id: String,
    pub turn_id: String,
...
mod tests {
    ...
    use crate::product::protocol::models::WebSearchAction as CoreWebSearchAction;
    use crate::product::protocol::protocol::NetworkAccess as CoreNetworkAccess;
    use crate::product::protocol::user_input::UserInput as CoreUserInput;
