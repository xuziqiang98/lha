...
use crate::product::mcp_server::codex_tool_runner::INVALID_PARAMS_ERROR_CODE;

/// Conforms to [`crate::product::mcp_types::ElicitRequestParams`] so that it can be used as the
...
pub(crate) async fn handle_exec_approval_request(
    command: Vec<String>,
    cwd: PathBuf,
    outgoing: Arc<crate::product::mcp_server::outgoing_message::OutgoingMessageSender>,
...
async fn on_exec_approval_response(
    event_id: String,
    receiver: tokio::sync::oneshot::Receiver<crate::product::mcp_types::Result>,
    codex: Arc<CodexThread>,
) {
