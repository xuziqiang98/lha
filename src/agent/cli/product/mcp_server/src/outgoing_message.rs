...
use crate::product::mcp_types::Result;
...
use crate::product::mcp_server::error_code::INTERNAL_ERROR_CODE;
...
// Additional mcp-specific data to be added to a [`crate::product::agent::protocol::Event`] as notification.params._meta
