...
use crate::product::state::model::ThreadMetadata;
use serde::Serialize;
...
fn apply_response_item(metadata: &mut ThreadMetadata, item: &TranscriptItem) {
...
fn extract_user_message_text(item: &TranscriptItem) -> Option<String> {
