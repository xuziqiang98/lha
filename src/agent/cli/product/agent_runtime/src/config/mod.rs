...
use crate::product::agent::config::models_json::provider_ref as models_provider_ref;
use crate::product::agent::config::state_json::load_state;
use crate::product::agent::config::types::DEFAULT_OTEL_ENVIRONMENT;
use crate::product::agent::config::types::History;
use crate::product::agent::config::types::McpServerConfig;
use crate::product::agent::config::types::McpServerDisabledReason;
use crate::product::agent::config::types::McpServerTransportConfig;
use crate::product::agent::config::types::MemoriesConfig;
use crate::product::agent::config::types::MemoriesToml;
use crate::product::agent::config::types::Notice;
use crate::product::agent::config::types::NotificationMethod;
use crate::product::agent::config::types::Notifications;
use crate::product::agent::config::types::Osc52TmuxMode;
use crate::product::agent::config::types::OtelConfig;
use crate::product::agent::config::types::OtelConfigToml;
use crate::product::agent::config::types::OtelExporterKind;
use crate::product::agent::config::types::SandboxWorkspaceWrite;
use crate::product::agent::config::types::ShellEnvironmentPolicy;
use crate::product::agent::config::types::ShellEnvironmentPolicyToml;
use crate::product::agent::config::types::SkillsConfig;
use crate::product::agent::config::types::Tui;
use crate::product::agent::config::types::TuiBuddy;
use crate::product::agent::config::types::UriBasedFileOpener;
...
use crate::product::agent::config_loader::LoaderOverrides;
use crate::product::agent::config_loader::McpServerIdentity;
use crate::product::agent::config_loader::McpServerRequirement;
use crate::product::agent::config_loader::ResidencyRequirement;
use crate::product::agent::config_loader::Sourced;
use crate::product::agent::config_loader::load_config_layers_state;
use crate::product::agent::features::Feature;
use crate::product::agent::features::FeatureOverrides;
use crate::product::agent::features::Features;
use crate::product::agent::features::FeaturesToml;
use crate::product::agent::git_info::resolve_root_git_project_for_trust;
use crate::product::agent::models_manager::model_info::find_model_info_for_slug;
use crate::product::agent::project_doc::DEFAULT_PROJECT_DOC_FILENAME;
use crate::product::agent::project_doc::LOCAL_PROJECT_DOC_FILENAME;
...
use crate::product::app_server_protocol::Tools;
...
use crate::product::utils_absolute_path::AbsolutePathBufGuard;
...
pub use crate::product::git_utils::GhostSnapshotConfig;
...
pub struct Config {
    ...
    /// [`crate::product::agent::exec::SandboxType::LinuxSeccomp`] is used. Note that this
    ...
    pub otel: crate::product::agent::config::types::OtelConfig,
}
        ...
        let config_toml: ConfigToml = match merged_toml.try_into() {
            ...
            Err(err) => {
                if let Some(config_error) =
                    crate::product::agent::config_loader::first_layer_config_error(
                        &config_layer_stack,
                    )
                    .await
                {
                    return Err(
                        crate::product::agent::config_loader::io_error_from_config_error(
...
impl Config {
    ...
    pub fn load_default_with_cli_overrides(
        ...
        let cli_layer =
            crate::product::agent::config_loader::build_cli_overrides_layer(&cli_overrides);
        crate::product::agent::config_loader::merge_toml_values(&mut merged, &cli_layer);
...
pub struct ConfigToml {
    ...
    #[schemars(schema_with = "crate::product::agent::config::schema::mcp_servers_schema")]
    ...
    /// When `false`, disables feedback collection across LHA product surfaces.
    /// Defaults to `true`.
    pub feedback: Option<crate::product::agent::config::types::FeedbackConfigToml>,

    /// OTEL configuration.
    pub otel: Option<crate::product::agent::config::types::OtelConfigToml>,

    /// Tracks whether the Windows onboarding screen has been acknowledged.
    pub windows_wsl_setup_acknowledged: Option<bool>,

    /// Collection of in-product notices (different from notifications)
    /// See [`crate::product::agent::config::types::Notices`] for more details
...
impl ConfigToml {
    ...
    fn derive_sandbox_policy(
        ...
        if cfg!(target_os = "windows")
            ...
            && windows_sandbox_level == crate::product::protocol::config_types::WindowsSandboxLevel::Disabled
        {
...
pub fn find_lha_home() -> std::io::Result<PathBuf> {
    crate::product::utils_home_dir::find_lha_home()
}
...
mod tests {
    ...
    use crate::product::agent::config::edit::apply_blocking;
    use crate::product::agent::config::types::FeedbackConfigToml;
    use crate::product::agent::config::types::HistoryPersistence;
    use crate::product::agent::config::types::McpServerTransportConfig;
    use crate::product::agent::config::types::NotificationMethod;
    use crate::product::agent::config::types::Notifications;
...
"#,
    ...
    fn feature_table_overrides_legacy_flags() -> std::io::Result<()> {
        ...
        let cfg = ConfigToml {
            features: Some(crate::product::agent::features::FeaturesToml { entries }),
            ..Default::default()
        };
