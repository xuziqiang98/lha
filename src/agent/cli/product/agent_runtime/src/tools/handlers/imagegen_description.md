...
- Always use this tool for image editing unless the user explicitly requests otherwise. Do not use shell or Python tools for image editing unless specifically instructed.
