...
use crate::product::agent::rollout;
use crate::product::agent::rollout::list::parse_timestamp_uuid_from_filename;
use crate::product::agent::rollout::recorder::RolloutRecorder;
...
use crate::product::state::BackfillStats;
use crate::product::state::DB_ERROR_METRIC;
use crate::product::state::DB_METRIC_BACKFILL;
use crate::product::state::DB_METRIC_BACKFILL_DURATION_MS;
use crate::product::state::ExtractionOutcome;
...
pub(crate) async fn backfill_sessions(
    runtime: &crate::product::state::StateRuntime,
    config: &Config,
    otel: Option<&OtelManager>,
) {
...
mod tests {
    use super::*;
    use crate::product::protocol::ThreadId;
    use crate::product::protocol::protocol::CompactedItem;
    use crate::product::protocol::protocol::RolloutItem;
    ...
    async fn extract_metadata_from_rollout_uses_session_meta() {
        ...
        let session_meta = SessionMeta {
            ...
            rollout_schema_version:
                crate::product::protocol::protocol::current_rollout_schema_version(),
