...
lha exec -c "model_providers.openai-proxy={ name = 'OpenAI Proxy', base_url = '${PROXY_BASE_URL}/v1', dialect='responses' }" \
...
- Authentication is fixed to `Authorization: Bearer <key>` to match the LHA CLI expectations.
