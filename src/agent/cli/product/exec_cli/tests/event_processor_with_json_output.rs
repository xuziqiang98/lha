...
use crate::product::exec_cli::event_processor_with_jsonl_output::EventProcessorWithJsonOutput;
use crate::product::exec_cli::exec_events::AgentMessageItem;
...
use crate::product::exec_cli::exec_events::McpToolCallItem;
use crate::product::exec_cli::exec_events::McpToolCallItemError;
use crate::product::exec_cli::exec_events::McpToolCallItemResult;
use crate::product::exec_cli::exec_events::McpToolCallStatus;
use crate::product::exec_cli::exec_events::PatchApplyStatus;
use crate::product::exec_cli::exec_events::PatchChangeKind;
use crate::product::exec_cli::exec_events::ReasoningItem;
use crate::product::exec_cli::exec_events::ThreadErrorEvent;
use crate::product::exec_cli::exec_events::ThreadEvent;
use crate::product::exec_cli::exec_events::ThreadItem;
use crate::product::exec_cli::exec_events::ThreadItemDetails;
use crate::product::exec_cli::exec_events::ThreadStartedEvent;
use crate::product::exec_cli::exec_events::TodoItem as ExecTodoItem;
use crate::product::exec_cli::exec_events::TodoListItem as ExecTodoListItem;
use crate::product::exec_cli::exec_events::TurnCompletedEvent;
use crate::product::exec_cli::exec_events::TurnFailedEvent;
use crate::product::exec_cli::exec_events::TurnStartedEvent;
use crate::product::exec_cli::exec_events::Usage;
use crate::product::exec_cli::exec_events::WebSearchItem;
...
use crate::product::protocol::protocol::ExecCommandOutputDeltaEvent;
use crate::product::protocol::protocol::ExecOutputStream;
...
fn session_configured_produces_thread_started_event() {
    ...
    let session_id =
        crate::product::protocol::ThreadId::from_string("67e55044-10b1-426f-9247-bb680e5fe0c8")
            .unwrap();
...
fn error_event_produces_error() {
    ...
    let out = ep.collect_thread_events(&event(
        "e1",
        EventMsg::Error(crate::product::agent::protocol::ErrorEvent {
...
fn stream_error_event_produces_error() {
    ...
    let out = ep.collect_thread_events(&event(
        "e1",
        EventMsg::StreamError(crate::product::agent::protocol::StreamErrorEvent {
