...
use crate::product::common::elapsed::format_duration;
use crate::product::common::elapsed::format_elapsed;
...
use crate::product::common::create_config_summary_entries;
...
pub(crate) struct EventProcessorWithHumanOutput {
    ...
    last_total_token_usage: Option<crate::product::agent::protocol::TokenUsageInfo>,
        ...
        match msg {
            ...
            EventMsg::McpStartupUpdate(update) => {
                let status_text = match update.status {
                    crate::product::agent::protocol::McpStartupStatus::Starting => {
                        "starting".to_string()
                    }
                    crate::product::agent::protocol::McpStartupStatus::Ready => "ready".to_string(),
                    crate::product::agent::protocol::McpStartupStatus::Cancelled => {
                        "cancelled".to_string()
                    }
                    crate::product::agent::protocol::McpStartupStatus::Failed { ref error } => {
                        format!("failed: {error}")
                    }
                };
                ts_msg!(
