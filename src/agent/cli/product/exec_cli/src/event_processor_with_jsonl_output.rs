...
use crate::product::agent::protocol;
...
use crate::product::exec_cli::exec_events::TodoItem;
use crate::product::exec_cli::exec_events::TodoListItem;
    ...
    pub fn collect_thread_events(&mut self, event: &protocol::Event) -> Vec<ThreadEvent> {
        match &event.msg {
            ...
            protocol::EventMsg::ItemCompleted(protocol::ItemCompletedEvent {
                item: crate::product::protocol::items::TurnItem::Plan(item),
                ..
            }) => {
