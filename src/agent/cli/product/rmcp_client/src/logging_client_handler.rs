...
use crate::product::rmcp_client::rmcp_client::SendElicitation;
...
impl ClientHandler for LoggingClientHandler {
    async fn create_elicitation(
        ...
        let id = match context.id {
            RequestId::String(id) => crate::product::mcp_types::RequestId::String(id.to_string()),
            RequestId::Number(id) => crate::product::mcp_types::RequestId::Integer(id),
        };
