...
use crate::product::keyring_store::DefaultKeyringStore;
use crate::product::keyring_store::KeyringStore;
use rmcp::transport::auth::AuthorizationManager;
use tokio::sync::Mutex;

use crate::product::utils_home_dir::find_lha_home;
...
mod tests {
    ...
    use crate::product::keyring_store::tests::MockKeyringStore;
