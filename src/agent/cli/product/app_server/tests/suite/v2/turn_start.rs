...
use crate::product::agent::protocol_config_types::ReasoningSummary;
use crate::product::app_server_protocol::ByteRange;
...
use crate::product::app_server_protocol::PatchChangeKind;
use crate::product::app_server_protocol::RequestId;
use crate::product::app_server_protocol::ServerRequest;
use crate::product::app_server_protocol::TextElement;
...
use crate::test_support::app_server::create_apply_patch_sse_response;
use crate::test_support::app_server::create_exec_command_sse_response;
...
use crate::test_support::app_server::format_with_current_shell_display;
...
async fn turn_start_exec_approval_toggle_v2() -> Result<()> {
    ...
    mcp.send_response(
        request_id,
        serde_json::json!({ "decision": crate::product::agent::protocol::ReviewDecision::Approved }),
    )
    .await?;
    timeout(
        DEFAULT_READ_TIMEOUT,
    ...
    let second_turn_id = mcp
        .send_turn_start_request(TurnStartParams {
            ...
            approval_policy: Some(crate::product::app_server_protocol::AskForApproval::Never),
            sandbox_policy: Some(
                crate::product::app_server_protocol::SandboxPolicy::DangerFullAccess,
            ),
            model: Some("mock-model".to_string()),
...
async fn turn_start_updates_sandbox_and_cwd_between_turns_v2() -> Result<()> {
    ...
    let first_turn = mcp
        .send_turn_start_request(TurnStartParams {
            ...
            approval_policy: Some(crate::product::app_server_protocol::AskForApproval::Never),
            sandbox_policy: Some(
                crate::product::app_server_protocol::SandboxPolicy::WorkspaceWrite {
...
"#;
    ...
    pretty_assertions::assert_eq!(
        started_changes,
        vec![crate::product::app_server_protocol::FileUpdateChange {
