...
use crate::product::agent::parse_command::shlex_join;
use crate::product::agent::protocol::ApplyPatchApprovalRequestEvent;
use crate::product::agent::protocol::CodexErrorInfo as CoreCodexErrorInfo;
...
use crate::product::agent::review_prompts;
use crate::product::app_server::codex_message_processor::ApiVersion;
use crate::product::app_server::codex_message_processor::PendingInterrupts;
use crate::product::app_server::codex_message_processor::PendingRollbacks;
use crate::product::app_server::codex_message_processor::TurnSummary;
use crate::product::app_server::codex_message_processor::TurnSummaryStore;
use crate::product::app_server::codex_message_processor::read_event_msgs_from_rollout;
use crate::product::app_server::codex_message_processor::read_summary_from_rollout;
use crate::product::app_server::codex_message_processor::summary_to_thread;
...
use crate::product::app_server_protocol::AgentMessageDeltaNotification;
use crate::product::app_server_protocol::ApplyPatchApprovalParams;
use crate::product::app_server_protocol::ApplyPatchApprovalResponse;
use crate::product::app_server_protocol::CodexErrorInfo as V2CodexErrorInfo;
use crate::product::app_server_protocol::CommandAction as V2ParsedCommand;
use crate::product::app_server_protocol::CommandExecutionApprovalDecision;
use crate::product::app_server_protocol::CommandExecutionOutputDeltaNotification;
use crate::product::app_server_protocol::CommandExecutionRequestApprovalParams;
use crate::product::app_server_protocol::CommandExecutionRequestApprovalResponse;
use crate::product::app_server_protocol::CommandExecutionStatus;
use crate::product::app_server_protocol::ContextCompactedNotification;
use crate::product::app_server_protocol::DeprecationNoticeNotification;
use crate::product::app_server_protocol::DynamicToolCallParams;
use crate::product::app_server_protocol::ErrorNotification;
use crate::product::app_server_protocol::ExecCommandApprovalParams;
use crate::product::app_server_protocol::ExecCommandApprovalResponse;
use crate::product::app_server_protocol::ExecPolicyAmendment as V2ExecPolicyAmendment;
use crate::product::app_server_protocol::FileChangeApprovalDecision;
use crate::product::app_server_protocol::FileChangeOutputDeltaNotification;
...
use crate::product::app_server_protocol::McpToolCallError;
use crate::product::app_server_protocol::McpToolCallResult;
use crate::product::app_server_protocol::McpToolCallStatus;
use crate::product::app_server_protocol::PatchApplyStatus;
use crate::product::app_server_protocol::PatchChangeKind as V2PatchChangeKind;
...
use crate::product::app_server_protocol::ReasoningSummaryPartAddedNotification;
use crate::product::app_server_protocol::ReasoningSummaryTextDeltaNotification;
use crate::product::app_server_protocol::ReasoningTextDeltaNotification;
use crate::product::app_server_protocol::ServerNotification;
use crate::product::app_server_protocol::ServerRequestPayload;
use crate::product::app_server_protocol::TerminalInteractionNotification;
use crate::product::app_server_protocol::ThreadItem;
use crate::product::app_server_protocol::ThreadNameUpdatedNotification;
use crate::product::app_server_protocol::ThreadRollbackResponse;
use crate::product::app_server_protocol::ThreadTokenUsage;
use crate::product::app_server_protocol::ThreadTokenUsageUpdatedNotification;
use crate::product::app_server_protocol::ToolRequestUserInputOption;
use crate::product::app_server_protocol::ToolRequestUserInputParams;
use crate::product::app_server_protocol::ToolRequestUserInputQuestion;
use crate::product::app_server_protocol::ToolRequestUserInputResponse;
use crate::product::app_server_protocol::Turn;
use crate::product::app_server_protocol::TurnCompletedNotification;
use crate::product::app_server_protocol::TurnDiffUpdatedNotification;
use crate::product::app_server_protocol::TurnError;
use crate::product::app_server_protocol::TurnInterruptResponse;
use crate::product::app_server_protocol::TurnPlanStep;
use crate::product::app_server_protocol::TurnPlanUpdatedNotification;
...
use crate::product::protocol::dynamic_tools::DynamicToolResponse as CoreDynamicToolResponse;
use crate::product::protocol::plan_tool::UpdatePlanArgs;
use crate::product::protocol::protocol::ReviewOutputEvent;
use crate::product::protocol::request_user_input::RequestUserInputAnswer as CoreRequestUserInputAnswer;
use crate::product::protocol::request_user_input::RequestUserInputResponse as CoreRequestUserInputResponse;
...
pub(crate) async fn apply_bespoke_event_handling(
    ...
    match msg {
        ...
        EventMsg::DynamicToolCallRequest(request) => {
            if matches!(api_version, ApiVersion::V2) {
                ...
                let rx = outgoing
                    ...
                    .await;
                tokio::spawn(async move {
                    crate::product::app_server::dynamic_tools::on_call_response(
                        call_id,
                        rx,
                        conversation,
                    )
        ...
        EventMsg::AgentMessageContentDelta(event) => {
            let crate::product::protocol::protocol::AgentMessageContentDeltaEvent {
                item_id,
                delta,
                ..
            } = event;
...
async fn maybe_emit_raw_transcript_item_completed(
    ...
    conversation_id: ThreadId,
    turn_id: &str,
    item: crate::product::protocol::models::TranscriptItem,
    outgoing: &OutgoingMessageSender,
) {
...
mod tests {
    ...
    use crate::product::app_server::CHANNEL_CAPACITY;
    use crate::product::app_server::outgoing_message::OutgoingMessage;
    use crate::product::app_server::outgoing_message::OutgoingMessageSender;
    use crate::product::app_server_protocol::TurnPlanStepStatus;
