...
use crate::product::tui_app::markdown;
...
impl MarkdownStreamCollector {
    ...
    pub fn commit_complete_lines(&mut self) -> Vec<Line<'static>> {
        ...
        if complete_line_count > 0
            && crate::product::tui_app::render::line_utils::is_blank_line_spaces_only(
...
mod tests {
    ...
    async fn e2e_stream_blockquote_wrap_preserves_green_style() {
        ...
        let wrapped = crate::product::tui_app::wrapping::word_wrap_lines(
            out.iter(),
            crate::product::tui_app::wrapping::RtOptions::new(24),
        );
    ...
    async fn heading_not_inlined_when_split_across_chunks() {
        ...
        crate::product::tui_app::markdown::append_markdown("Hello.\n", None, &mut rendered);
    ...
    async fn utf8_boundary_safety_and_wide_chars() {
        ...
        crate::product::tui_app::markdown::append_markdown(input, None, &mut rendered_all);
    ...
    async fn loose_list_with_split_dashes_matches_full_render() {
        ...
        let mut rendered_all: Vec<ratatui::text::Line<'static>> = Vec::new();
        crate::product::tui_app::markdown::append_markdown(&full, None, &mut rendered_all);
    ...
    async fn assert_streamed_equals_full(deltas: &[&str]) {
        ...
        let full: String = deltas.iter().copied().collect();
        let mut rendered: Vec<ratatui::text::Line<'static>> = Vec::new();
        crate::product::tui_app::markdown::append_markdown(&full, None, &mut rendered);
