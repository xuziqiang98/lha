...
use crate::product::tui_app::bottom_pane::selection_popup_common::menu_surface_padding_height;
use crate::product::tui_app::bottom_pane::selection_popup_common::render_menu_surface;
use crate::product::tui_app::bottom_pane::selection_popup_common::render_rows;
use crate::product::tui_app::bottom_pane::selection_popup_common::wrap_styled_line;
...
struct UnansweredConfirmationData {
    ...
    rows: Vec<crate::product::tui_app::bottom_pane::selection_popup_common::GenericDisplayRow>,
    state: ScrollState,
}
