...
use crate::product::tui_app::bottom_pane::queued_user_messages::QueuedUserMessages;
use crate::product::tui_app::bottom_pane::unified_exec_footer::UnifiedExecFooter;
use crate::product::tui_app::key_hint;
use crate::product::tui_app::key_hint::KeyBinding;
use crate::product::tui_app::render::renderable::FlexRenderable;
use crate::product::tui_app::render::renderable::Renderable;
use crate::product::tui_app::render::renderable::RenderableItem;
...
use crate::product::tui_app::status_indicator_widget::StatusIndicatorWidget;
...
impl BottomPane {
    ...
    pub(crate) fn set_queued_user_messages(&mut self, queued: Vec<String>) {
        if self.queued_user_messages.messages == queued {
            return;
        }
    ...
    pub(crate) fn buddy_state(&self) -> &crate::product::tui_app::buddy::state::BuddyState {
