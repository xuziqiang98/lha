...
use crate::product::protocol::user_input::TextElement as UserTextElement;
use crate::product::tui_app::key_hint::is_altgr;
...
impl TextArea {
    ...
    fn wrapped_lines(&self, width: u16) -> Ref<'_, Vec<Range<usize>>> {
        // Ensure cache is ready (potentially mutably borrow, then drop)
        {
            ...
            if needs_recalc {
                let lines = crate::product::tui_app::wrapping::wrap_ranges(
                    &self.text,
