...
impl SlashCommand {
    ...
    pub fn description(self) -> &'static str {
        match self {
            ...
            SlashCommand::Init => "create an AGENTS.md file with instructions for LHA",
            SlashCommand::Compact => "summarize conversation to prevent hitting the context limit",
            SlashCommand::Review => "review my current changes and find issues",
            SlashCommand::Rename => "rename the current thread",
            SlashCommand::Resume => "resume a saved chat",
            SlashCommand::Fork => "fork the current chat",
            // SlashCommand::Undo => "ask LHA to undo a turn",
            SlashCommand::Quit | SlashCommand::Exit => "exit LHA",
            SlashCommand::Diff => "show git diff (including untracked files)",
            SlashCommand::Mention => "mention a file",
            SlashCommand::Skills => "use skills to improve how LHA performs specific tasks",
            ...
            SlashCommand::Personality => "choose a communication style for LHA",
            SlashCommand::Identity => "choose LHA identity",
            SlashCommand::Changelog => "show added, modified, and deleted files",
            SlashCommand::Approvals => "choose what LHA can do without approval",
