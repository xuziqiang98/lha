...
use crate::terminal_palette::best_color_distinct_from;
...
mod tests {
    use super::*;
    use crate::terminal_palette::nearest_xterm_fixed_color;
    use crate::terminal_palette::nearest_xterm_fixed_color_distinct_from;
