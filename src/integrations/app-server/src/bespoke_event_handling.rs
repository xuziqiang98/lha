...
use lha_agent::parse_command::shlex_join;
use lha_agent::protocol::ApplyPatchApprovalRequestEvent;
use lha_agent::protocol::CodexErrorInfo as CoreCodexErrorInfo;
...
use lha_agent::protocol::FileChange as CoreFileChange;
...
use lha_agent::review_format::format_review_findings_block;
use lha_agent::review_prompts;
use lha_app_server_protocol::AgentMessageDeltaNotification;
use lha_app_server_protocol::ApplyPatchApprovalParams;
use lha_app_server_protocol::ApplyPatchApprovalResponse;
use lha_app_server_protocol::CodexErrorInfo as V2CodexErrorInfo;
use lha_app_server_protocol::CommandAction as V2ParsedCommand;
use lha_app_server_protocol::CommandExecutionApprovalDecision;
use lha_app_server_protocol::CommandExecutionOutputDeltaNotification;
use lha_app_server_protocol::CommandExecutionRequestApprovalParams;
use lha_app_server_protocol::CommandExecutionRequestApprovalResponse;
use lha_app_server_protocol::CommandExecutionStatus;
use lha_app_server_protocol::ContextCompactedNotification;
use lha_app_server_protocol::DeprecationNoticeNotification;
use lha_app_server_protocol::DynamicToolCallParams;
use lha_app_server_protocol::ErrorNotification;
use lha_app_server_protocol::ExecCommandApprovalParams;
use lha_app_server_protocol::ExecCommandApprovalResponse;
use lha_app_server_protocol::ExecPolicyAmendment as V2ExecPolicyAmendment;
use lha_app_server_protocol::FileChangeApprovalDecision;
use lha_app_server_protocol::FileChangeOutputDeltaNotification;
use lha_app_server_protocol::FileChangeRequestApprovalParams;
use lha_app_server_protocol::FileChangeRequestApprovalResponse;
use lha_app_server_protocol::FileUpdateChange;
...
use lha_app_server_protocol::McpToolCallError;
use lha_app_server_protocol::McpToolCallResult;
use lha_app_server_protocol::McpToolCallStatus;
use lha_app_server_protocol::PatchApplyStatus;
use lha_app_server_protocol::PatchChangeKind as V2PatchChangeKind;
use lha_app_server_protocol::PlanDeltaNotification;
use lha_app_server_protocol::RawTranscriptItemCompletedNotification;
use lha_app_server_protocol::ReasoningSummaryPartAddedNotification;
use lha_app_server_protocol::ReasoningSummaryTextDeltaNotification;
use lha_app_server_protocol::ReasoningTextDeltaNotification;
use lha_app_server_protocol::ServerNotification;
use lha_app_server_protocol::ServerRequestPayload;
use lha_app_server_protocol::TerminalInteractionNotification;
use lha_app_server_protocol::ThreadItem;
use lha_app_server_protocol::ThreadNameUpdatedNotification;
use lha_app_server_protocol::ThreadRollbackResponse;
use lha_app_server_protocol::ThreadTokenUsage;
use lha_app_server_protocol::ThreadTokenUsageUpdatedNotification;
use lha_app_server_protocol::ToolRequestUserInputOption;
use lha_app_server_protocol::ToolRequestUserInputParams;
use lha_app_server_protocol::ToolRequestUserInputQuestion;
use lha_app_server_protocol::ToolRequestUserInputResponse;
use lha_app_server_protocol::Turn;
use lha_app_server_protocol::TurnCompletedNotification;
use lha_app_server_protocol::TurnDiffUpdatedNotification;
use lha_app_server_protocol::TurnError;
use lha_app_server_protocol::TurnInterruptResponse;
use lha_app_server_protocol::TurnPlanStep;
use lha_app_server_protocol::TurnPlanUpdatedNotification;
use lha_app_server_protocol::TurnStatus;
use lha_app_server_protocol::build_turns_from_event_msgs;
use lha_protocol::ThreadId;
use lha_protocol::dynamic_tools::DynamicToolResponse as CoreDynamicToolResponse;
use lha_protocol::plan_tool::UpdatePlanArgs;
use lha_protocol::protocol::ReviewOutputEvent;
use lha_protocol::request_user_input::RequestUserInputAnswer as CoreRequestUserInputAnswer;
use lha_protocol::request_user_input::RequestUserInputResponse as CoreRequestUserInputResponse;
...
pub(crate) async fn apply_bespoke_event_handling(
    ...
    match msg {
        ...
        EventMsg::AgentMessageContentDelta(event) => {
            let lha_protocol::protocol::AgentMessageContentDeltaEvent { item_id, delta, .. } =
                event;
...
async fn maybe_emit_raw_transcript_item_completed(
    ...
    conversation_id: ThreadId,
    turn_id: &str,
    item: lha_protocol::models::TranscriptItem,
    outgoing: &OutgoingMessageSender,
) {
...
mod tests {
    ...
    use lha_app_server_protocol::TurnPlanStepStatus;
