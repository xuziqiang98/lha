...
impl TestToolServer {
    ...
    /// Tool intended for manual testing of LHA TUI rendering for MCP image tool results.
    ///
    ...
    /// - Build this binary: `cargo build -p lha-rmcp-client --bin test_stdio_server`
    /// - Register it:
    ///   - `lha mcp add mcpimg -- /abs/path/to/test_stdio_server`
    /// - Then in LHA TUI, ask it to call:
...
/// Scenarios for `image_scenario`, intended to exercise LHA TUI handling of MCP image outputs.
///
